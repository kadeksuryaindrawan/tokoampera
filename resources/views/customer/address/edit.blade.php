            ...
            <div class="container">
                ...
                <div class="col-12">
                    <div class="content-header">
                        <h2 class="content-title">Edit Alamat</h2>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Alamat" name="nama_alamat" class="form-control" value="{{ $customerAddress->nama_alamat }}" id="nama_alamat" required>
                                            @error('nama_alamat')
