            ...
            <div class="row">
                <div class="col-12">
                    <div class="content-header">
                        <h2 class="content-title">Tambah Voucher</h2>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('vouchers.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" placeholder="Masukkan Nama Voucher" name="nama" class="form-control" id="nama" required>
                                            @error('nama')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" placeholder="Masukkan Nominal" name="nominal" class="form-control" id="nominal" required>
                                            @error('nominal')
                                                <div class="text-danger text-sm">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file" name="gambar_voucher" class="form-control" id="gambar_voucher" required>
