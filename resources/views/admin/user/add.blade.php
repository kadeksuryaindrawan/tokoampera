                            ...
                            <form method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="email" placeholder="Masukkan Email" name="email" class="form-control" id="email" required>
                                            @error('email')
                                                <div class="text-danger text-sm">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="password" placeholder="Masukkan Password" name="password" class="form-control" id="password" required>
